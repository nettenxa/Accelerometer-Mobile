...
//        FirebaseDatabase.getInstance().getReference().setValue(yValue);
        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference myRef = database.getReference("xValue");
        myRef.setValue(sensorEvent.values[0]);
        DatabaseReference myRef1 = database.getReference("yValue");
        myRef1.setValue(sensorEvent.values[1]);
        DatabaseReference myRef2 = database.getReference("zValue");
        myRef2.setValue(sensorEvent.values[2]);
    }
